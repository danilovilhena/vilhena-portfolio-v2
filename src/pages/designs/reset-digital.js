...
const ResetDigital = () => (
    <Layout title="Flow Podcast" description="Desenvolvedor front-end com ênfase na acessibilidade e otimização dos sites. Projeto de redesign para um site de captura">
        <header className="project-header" style={{background: 'linear-gradient(72.44deg, #383933 50%, #191C18 100%)', padding: '2rem 0 0 0'}}>
            <img src={projectImage} alt="Projeto de redesign do Reset Digital" data-aos="fade-down"></img>
        </header>
        <main className="project-main" data-aos="fade-up">
            <h1>Redesign do Reset Digital</h1>
            <p className="project-date"><span alt="Calendário">📅</span> Maio de 2021</p>
            ...
            <a href="https://www.figma.com/file/z3sgSuLo1ExYnce9tMhIj7/o-reset-digital?node-id=101%3A2" className="project-link">
