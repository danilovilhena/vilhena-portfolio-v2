...
const LandingVendas = () => (
    <Layout title="Flow Podcast" description="Desenvolvedor front-end com ênfase na acessibilidade e otimização dos sites. Projeto de redesign para o site do maior podcast do Brasil">
        <header class="project-header" style={{background: '#FFB709', padding: '2rem 0 0 0'}}>
            <img src={projectImage} alt="Projeto de redesign do Flow Podcast" data-aos="fade-down"></img>
        </header>
        <main className="project-main" data-aos="fade-up">
            ...
            <img src={before} alt="Site antes do redesign do Flow Podcast" class="project-result-image"></img>
            <h2>Depois do redesign</h2>
            <img src={result} alt="Resultado do redesign do Flow Podcast" class="project-result-image"></img>

            <h2>Links de acesso</h2>
            <a href="https://www.figma.com/file/x8uDJ37ZdP0lgadsgLhJR1/flow-podcast?node-id=202%3A1525" class="project-link">
