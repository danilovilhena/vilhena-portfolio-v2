...
const DoWhat = () => (
    <Layout title="do what?" description="Desenvolvedor front-end e UI designer com ênfase na acessibilidade e otimização dos sites. Projeto de design do what?">
        <header className="project-header" style={{background: 'linear-gradient(107.57deg, #55D96B -4.12%, #25AA3B 104.25%)'}}>
            <img src={projectImage} alt="Projeto de design do what?" data-aos="fade-down"></img>
        </header>
        <main className="project-main" data-aos="fade-up">
            ...
            <a href="https://www.figma.com/file/vEbTiEOYDMnq6WrsWz9UgL/Tuttory" className="project-link" target="_blank">
