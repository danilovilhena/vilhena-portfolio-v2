...
const BlogPage = () => {
    ...
    <Layout>
        ...
        description="Descubra mais detalhes sobre a página Give me a font que desenvolvi."/>

        <main className="mx-auto" id="ProjectMain">
            <div id="title">
                <img src={Pencil} height="65" alt="Ilustração de um caixa de lápis"></img>
                <h2>Give me a font</h2>
            </div>
            <img id="project-img" src={GMFImage} alt="Imagem do Give me a Font" style={{marginBottom: '2rem'}}></img>
            <div id="buttons">
                ...
                <a id="regular-button" href="https://danilovilhena.github.io/give-me-a-font" target="_blank" rel="noreferrer">Aplicação</a>
            </div>
            <section id="description">
                <h3>Descrição da aplicação</h3>
                <div style={{display: 'flex', alignItems: 'center', margintop: '1rem'}}>
                    <img src={Ellipse} aria-hidden="true" alt=""></img>
                    <p>Aplicação para gerar fontes grátis aleatórias baseadas na escolha de um estilo para usar no seu próximo projeto.</p>
                </div>
            </section>
            ...
            <section id="details">
                ...
                <ul style={{marginLeft: "-1rem"}}>
                    ...
                    <li style={{marginBottom: "1rem"}}><img style={{marginTop: "-0.5rem"}} src={Ellipse} aria-hidden="true" alt=""></img>Consumi a Google Fonts API para pegar as fontes</li>
